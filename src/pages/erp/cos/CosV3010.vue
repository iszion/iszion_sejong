  ...
  <q-page class="q-pa-xs-xs q-pa-sm-md">
    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 50vh">
      <q-card class="q-pb-xl" style="width: 100%; max-width: 50vh">
        <q-card-section class="q-gutter-y-lg bg-teal-4">
          <div class="text-h4 text-center">손익계산</div>
          <div class="text-subtitle2 text-right">손익계산 기준년월을 설정하세요</div>
        </q-card-section>
        ...
        <q-card-section>
          <div class="row justify-center q-gutter-y-xl">
            <q-btn
              ...
              icon="calculate"
            >
              <span class="q-ml-md"> 손익 계산 진행</span>
...
const getProcedure = async () => {
  try {
    const res = await api.post('/api/cos/cos3010_procedure', {
