...
import CompToggleCom from 'components/CompToggleCom.vue';
...
const saveDataAndHandleResult = resFormData => {
  api
    .post('/api/com/com2010_grntg_save', resFormData)
    .then(res => {
...
const getData = async () => {
  try {
    const response = await api.post('/api/com/com2010_grntg_list', {
