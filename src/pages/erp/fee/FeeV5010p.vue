              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th rowspan="3" colspan="1">전자책정산</th>
                    <th rowspan="3" colspan="1">중간정산액</th>
                    <th rowspan="1" colspan="3">선인세정산</th>
                  ...
                  <tr>
                    ...
                    <th rowspan="2" colspan="1">선인세</th>
                    <th rowspan="2" colspan="1">지급정산인세</th>
                    <th rowspan="2" colspan="1">선인세잔액</th>
                  </tr>
                  <tr>
                ...
                <tbody>
                  <tr v-for="(data, index) in props.messages.rowData.rows || []" :key="index">
                    ...
                    <td>{{ commUtil.formatComma(data.detAmt) }}</td>
                  ...
                  <tr class="bg-grey3">
                    ...
                    <td>{{ commUtil.formatComma(props.messages.rowData.rowsSum[0].detAmt) }}</td>
...
const isPrintReport = () => {
  printJS({
    printable: 'printZone',
    type: 'html',
    css: ['/css/print/fee5010.css', '/css/quasar.css'],
    scanStyles: false,
  });
};
...
const headerGroup = reactive({
  ...
  headRow1: [
    ...
    { rowspan: 3, colspan: 1, name: '전자책정산', key: 'detAmt' },
...
<style scoped>
@import 'src/css/print/fee5010.css';
</style>
