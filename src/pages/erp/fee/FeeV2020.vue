    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 50vh">
      <q-card class="q-pb-xl" style="width: 100%; max-width: 50vh">
        <q-card-section class="q-gutter-y-lg bg-red-4">
          <div class="text-h4 text-center">인세계산 작업취소</div>
          <div class="text-subtitle2 text-right">취소할 계산작업 기간을 설정하세요</div>
        </q-card-section>
        ...
        <q-card-section>
          <div class="row justify-center q-gutter-y-xl">
            <q-btn
              ...
              icon="calculate"
            >
              <span class="q-ml-md"> 인세계산 취소진행</span>
...
const getProcedure = async () => {
  try {
    const response = await api.post('/api/fee/fee2020_procedure', {
