    ...
    <q-card class="q-pa-sm">
      <q-toolbar class="q-px-sm q-pt-none">
        <div class="row q-col-gutter-x-md">
          ...
          <q-input stack-label bottom-slots label-color="orange" v-model="searchValue.textValue" label="검색" class="q-pb-none" style="width: 200px">
    ...
    <q-dialog persistent full-height full-width v-model="isDialogVisible">
      <q-card class="q-pa-none q-ma-none">
        <q-card-section class="q-pa-none q-ma-none">
          <fee-v5020p :messages="{ rowData: rowData, titleNm: menuLabel, searchValue: searchValue }" @close="handleClose" />
        </q-card-section>
      </q-card>
    </q-dialog>
  </q-page>
...
import FeeV5020p from 'pages/erp/fee/FeeV5020p.vue';
...
const getDataMonth = async () => {
  try {
    const response = await api.post('/api/fee/fee5010_month_list', {
...
const getData = async () => {
  try {
    const response = await api.post('/api/fee/fee5010_list', {
      paramYear: searchValue.year,
