            ...
            <div id="printZone">
              ...
              <table>
                <tr>
                  ...
                  <th rowspan="1" colspan="1">코드</th>
                  <th rowspan="1" colspan="1">적용월</th>
                  <th rowspan="1" colspan="1">
                    <span v-if="props.messages.searchValue.prodCl === '1'">기지급금액</span>
                    <span v-if="props.messages.searchValue.prodCl === '2'">선인세</span>
                  </th>
                  <th rowspan="1" colspan="1">인세정산금액</th>
                  <th rowspan="1" colspan="1">인세정산수량</th>
...
const isPrintReport = () => {
  printJS({
    printable: 'printZone',
    type: 'html',
    css: ['/css/print/fee3020.css', '/css/quasar.css'],
    scanStyles: false,
  });
};
...
const headerGroup = reactive({
  header: [],
  headProps: ['prodNm', 'prodCd', 'agentNm', 'agentCd', 'procMonth', 'sAmt', 'oAmt', 'oQty', 'remarks'],
  headRow1: [
    ...
    { name: '적용일', rowspan: 1, colspan: 1, key: 'procMonth' },
    { name: props.messages.searchValue.prodCl === '1' ? '기지급금' : '선인세', rowspan: 1, colspan: 1, key: 'sAmt' },
    { name: '인세정산금액', rowspan: 1, colspan: 1, key: 'oAmt' },
    { name: '인세정산수량', rowspan: 1, colspan: 1, key: 'oQty' },
...
<style scoped>
@import 'src/css/print/fee3020.css';
</style>
