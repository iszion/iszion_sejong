          ...
          <q-scroll-area style="height: 100vh">
            <div id="printZone">
              <div class="row">
                ...
                <q-space />
                <span class="text-subtitle1 text-bold self-end">출고기간 : {{ props.messages.stdYear }}년 {{ props.messages.stdMonth }}월</span>
              </div>
...
const isPrintReport = () => {
  printJS({
    printable: 'printZone',
    type: 'html',
    css: ['/css/print/sal3110.css', '/css/quasar.css'],
    scanStyles: false,
  });
};
onBeforeMount(() => {
  console.log('aa : ', JSON.stringify(props.messages.rowData));
});
/* ************************************************************************* *
 ** Excel저장  처리부분
 ** ************************************************************************* */
...
<style scoped>
@import 'src/css/print/sal3110.css';
</style>
