...
const isPrintReport = () => {
  printJS({
    printable: 'printZone',
    type: 'html',
    css: ['/css/print/sal4430.css', '/css/quasar.css'],
    scanStyles: false,
  });
};
...
const headerGroup = reactive({
  header: [],
  headProps: ['custNm', 'custCd', 'wAmt', 'oQty', 'oAmt', 'obQty', 'obAmt', 'ojQty', 'inAmt', 'jAmt'],
  headRow1: [
    { name: '거래처명', rowspan: 2, colspan: 1, key: 'prodNm' },
    { name: '코드', rowspan: 2, colspan: 1, key: 'prodCd' },
    { name: '전일잔액', rowspan: 2, colspan: 1, key: 'wAmt' },
    { name: '판매', rowspan: 1, colspan: 2 },
    { name: '반품', rowspan: 1, colspan: 2 },
    { name: '증정수량', rowspan: 2, colspan: 1, key: 'ojQty' },
    { name: '수금액', rowspan: 2, colspan: 1, key: 'inAmt' },
    { name: '당일잔액', rowspan: 2, colspan: 1, key: 'jAmt' },
  ],
  headRow2: [
...
<style scoped>
@import 'src/css/print/sal4430.css';
</style>
